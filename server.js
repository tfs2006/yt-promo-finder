...
app.post("/api/signal-desk-webhook", express.json({ limit: "128kb" }), predictorHandler);
app.get("/api/signal-desk-leads", predictorHandler);
app.patch("/api/signal-desk-leads", express.json({ limit: "128kb" }), predictorHandler);
